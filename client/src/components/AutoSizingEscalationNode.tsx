...
interface AutoSizingEscalationNodeProps {
  data: any;
  selected: boolean;
  id: string;
}

const AutoSizingEscalationNode: React.FC<AutoSizingEscalationNodeProps> = ({ data, selected, id }) => {
...
export default AutoSizingEscalationNode;
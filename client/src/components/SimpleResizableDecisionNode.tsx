...
interface SimpleResizableDecisionNodeProps {
  data: any;
  selected: boolean;
  id: string;
}

const SimpleResizableDecisionNode: React.FC<SimpleResizableDecisionNodeProps> = ({ data, selected, id }) => {
...
export default SimpleResizableDecisionNode;
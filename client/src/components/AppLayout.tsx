  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-background border-t border-border py-2 px-4 flex justify-center items-center gap-8 shadow-lg">
        ...
        <Link href="/settings">
          <div className={`flex flex-col items-center px-4 py-2 hover:text-primary rounded-md transition-colors cursor-pointer ${location === '/settings' ? 'text-primary' : 'text-muted-foreground'}`}>
